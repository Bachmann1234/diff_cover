...
class PylintQualityReporterTest(unittest.TestCase):
    ...
    def test_quality(self):
        ...
        violations = [Violation(1, 'C0111: Missing docstring'), Violation(1, 'C0111: func_1: Missing docstring'), Violation(2, "W0612: func_1: Unused variable 'd'"), Violation(2, "W0511: TODO: Not the real way we'll store usages!")]
        name = "pylint"
